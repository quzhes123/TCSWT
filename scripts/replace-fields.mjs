...
const NEW_FIELDS = [
  ...
  { key: 'team', label: '组织架构', group: 'basic',
    hint: '客户团队规模与组成、关键部门设置（如风控部/技术部/海外事业部）。优先从公司官网「关于我们/团队」、年报「组织架构」章节、企查查主要人员与参保人数、以及 36氪/媒体对高管团队的公开报道中获取；LinkedIn/脉脉信息更全但常被区域屏蔽或反爬，作为备选。',
    source_note: '官网关于我们 + 企查查/天眼查 + 年报组织架构章节 + 媒体报道（LinkedIn/脉脉备选）',
    reference_urls: [URL.qcc, URL.tianyan, URL.cninfo, URL.linkedin, URL.maimai] },
